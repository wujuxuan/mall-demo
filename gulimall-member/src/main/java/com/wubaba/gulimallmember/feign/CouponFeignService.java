package com.wubaba.gulimallmember.feign;
...
public interface CouponFeignService{
    // 远程服务的url
    @RequestMapping("/gulimallcoupon/smscoupon/member/list")//注意写全优惠券类上还有映射//注意我们这个地方不是控制层，所以这个请求映射请求的不是我们服务器上的东西，而是nacos注册中心的
