 ...
 */
@RestController
@RequestMapping("gulimallware/wmswareordertaskdetail")
public class WmsWareOrderTaskDetailController {
     ...
     */
    @RequestMapping("/list")
    public R list(Page pageForm, WmsWareOrderTaskDetailEntity wmsWareOrderTaskDetail){
        Page page = wmsWareOrderTaskDetailService.page(pageForm, Wrappers.query(wmsWareOrderTaskDetail));
    ...
    public R info(@PathVariable("id") Long id){
       ...
       // return R.ok().put("wmsWareOrderTaskDetail", wmsWareOrderTaskDetail);
        return R.success("查询成功",wmsWareOrderTaskDetail);
    }
