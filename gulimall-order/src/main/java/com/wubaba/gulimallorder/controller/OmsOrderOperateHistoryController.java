...
import com.wubaba.gulimallorder.service.OmsOrderOperateHistoryService;
 ...
 */
@RestController
@RequestMapping("gulimallorder/omsorderoperatehistory")
public class OmsOrderOperateHistoryController {
     ...
     */
    @RequestMapping("/list")
    public R list(Page pageForm, OmsOrderOperateHistoryEntity omsOrderOperateHistory){
        Page page = omsOrderOperateHistoryService.page(pageForm, Wrappers.query(omsOrderOperateHistory));
    ...
    public R info(@PathVariable("id") Long id){
       ...
       // return R.ok().put("omsOrderOperateHistory", omsOrderOperateHistory);
        return R.success("查询成功",omsOrderOperateHistory);
    }
