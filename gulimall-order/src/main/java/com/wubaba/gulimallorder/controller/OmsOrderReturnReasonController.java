 ...
 */
@RestController
@RequestMapping("gulimallorder/omsorderreturnreason")
public class OmsOrderReturnReasonController {
     ...
     */
    @RequestMapping("/list")
    public R list(Page pageForm, OmsOrderReturnReasonEntity omsOrderReturnReason){
        Page page = omsOrderReturnReasonService.page(pageForm, Wrappers.query(omsOrderReturnReason));
    ...
    public R info(@PathVariable("id") Long id){
       ...
       // return R.ok().put("omsOrderReturnReason", omsOrderReturnReason);
        return R.success("查询成功",omsOrderReturnReason);
    }
