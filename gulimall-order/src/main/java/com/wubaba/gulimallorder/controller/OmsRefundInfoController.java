...
import com.wubaba.gulimallorder.entity.OmsRefundInfoEntity;
import com.wubaba.gulimallorder.service.OmsRefundInfoService;
 ...
 */
@RestController
@RequestMapping("gulimallorder/omsrefundinfo")
public class OmsRefundInfoController {
     ...
     */
    @RequestMapping("/list")
    public R list(Page pageForm, OmsRefundInfoEntity omsRefundInfo){
        Page page = omsRefundInfoService.page(pageForm, Wrappers.query(omsRefundInfo));
    ...
    public R info(@PathVariable("id") Long id){
       ...
       // return R.ok().put("omsRefundInfo", omsRefundInfo);
        return R.success("查询成功",omsRefundInfo);
    }
